 ...
 * Fel hemlighet ger false (401). En tabell som inte går att läsa ger
 * ett kastat fel (500) — det är servern som är trasig, inte anroparen.
 * Ett omförsök innan dess, för kalla isolat.
 */

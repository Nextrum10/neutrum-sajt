-- ============================================================
-- NEXTRUM — schema v13, agenterna
--
-- Körs efter schema-v12.sql. ÄR applicerad i projektet
-- ddkfiuvcppalutfulvbi (agent_korningar, agent_steg,
-- foretagsfakta och fortnox_token finns där).
--
-- Två migrationer skrevs som v13 på var sin gren och båda kördes
-- mot samma databas: schema-v13.sql gav adminvyn skrivrätt, den
-- här la till agenternas bord. De rör inga gemensamma tabeller.
-- Filnamnet skiljer dem åt i efterhand; numret gör det inte.
--
